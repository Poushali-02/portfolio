            ...
            <div className="about-svg">
              <svg width="220" height="220" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="50" y="50" width="120" height="120"
                  fill="none" stroke="#B0B0B0" strokeWidth="6"
                  strokeLinejoin="round" />
                <line x1="90" y1="40" x2="90" y2="50" stroke="#B0B0B0" strokeWidth="6" strokeLinecap="round" />
                <circle cx="90" cy="36" r="4" fill="#B0B0B0" />
                <line x1="130" y1="40" x2="130" y2="50" stroke="#B0B0B0" strokeWidth="6" strokeLinecap="round" />
                <circle cx="130" cy="36" r="4" fill="#B0B0B0" />

                <line x1="90" y1="170" x2="90" y2="180" stroke="#B0B0B0" strokeWidth="6" strokeLinecap="round" />
                <circle cx="90" cy="184" r="4" fill="#B0B0B0" />
                <line x1="130" y1="170" x2="130" y2="180" stroke="#B0B0B0" strokeWidth="6" strokeLinecap="round" />
                <circle cx="130" cy="184" r="4" fill="#B0B0B0" />

                <line x1="40" y1="90" x2="50" y2="90" stroke="#B0B0B0" strokeWidth="6" strokeLinecap="round" />
                <circle cx="36" cy="90" r="4" fill="#B0B0B0" />
                <line x1="40" y1="130" x2="50" y2="130" stroke="#B0B0B0" strokeWidth="6" strokeLinecap="round" />
                <circle cx="36" cy="130" r="4" fill="#B0B0B0" />

                <line x1="170" y1="90" x2="180" y2="90" stroke="#B0B0B0" strokeWidth="6" strokeLinecap="round" />
                <circle cx="184" cy="90" r="4" fill="#B0B0B0" />
                <line x1="170" y1="130" x2="180" y2="130" stroke="#B0B0B0" strokeWidth="6" strokeLinecap="round" />
                <circle cx="184" cy="130" r="4" fill="#B0B0B0" />

                <g transform="translate(60,60)" stroke="#B0B0B0" strokeWidth="5" fill="none" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M50 20
                        C40 10, 25 10, 20 22
                        C10 25, 10 40, 18 46
                        C10 55, 15 70, 27 72
